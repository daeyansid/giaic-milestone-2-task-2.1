            ...
            <article className="max-w-auto border shadow-lg shadow-gray-600 border-black py-24 px-10 mx-10 space-y-12 dark:bg-gray-100 dark:text-gray-900">
                ...
                <div className="pt-12 border-t dark:border-gray-300">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 align-center">
                        <a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-purple-600">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-purple-600">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-purple-600">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-purple-600">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
